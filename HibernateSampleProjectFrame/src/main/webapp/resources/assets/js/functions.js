...
$(function () {
        ...
        $('#tabel1').highcharts({
            ...
            tooltip: {
                headerFormat: '<span style="font-weight:bold";>Data Source:<br> Voice<br>Value:<br></span><table>',
                pointFormat: '<tr><td></td>'+
            ...
            series: [{
                name: '',
                color: '#70cbfa',
                data: [17, 17, 17, 15, 18, 17, 19, 20, 15, 15 ,15]
            }, {	
                color: '#429dfa',
                name: '',
                data: [27, 27, 26, 25, 24, 23, 27, 26, 28, 26, 26]
            }, {
            	color: '#1470cb',
                name: '',
                data: [12, 14, 14, 12, 15, 10, 15, 18, 18, 16, 16]
            }]
...
$(function () {
        $('#tabel2').highcharts({
            ...
            legend: {
             ...
             tooltip: {
                headerFormat: '<span style="font-weight:bold";>Data Source:<br> Dataflow<br>Value:<br></span><table>',
                pointFormat: '<tr><td></td>'+
                    '<td style="padding:0"><b>{point.y:.1f}GBps</b></td></tr>',
                footerFormat: '</table>',
                shared: false,
                useHTML: true
            },
...
$(function () {
        $('#tabel3').highcharts({
            ...
            tooltip: {
                headerFormat: '<span style="font-weight:bold";>Earnings:</span><table>',
                pointFormat: '<tr><td></td>'+
            ...
            series: [{
                name: '',
                data: [502, 635, 809, 947, 1402, 3634, 5268, 8888, 4444, 1111, 2222, 3333]
            },]
        });
    });
...
//close third table
$(".tabel3").click(function () {
  $(".tabel3").remove();
});

//close four table
$(".tabel4").click(function () {
  $(".tabel4").remove();
});

//close five table
$(".tabel5").click(function () {
  $(".tabel5").remove();
});