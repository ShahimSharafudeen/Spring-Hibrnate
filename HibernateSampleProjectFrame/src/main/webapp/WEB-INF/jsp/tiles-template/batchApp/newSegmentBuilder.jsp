<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/sift/batchApp/create_segment.js"></script>
<script
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<form class="form-horizontal form-Program"
						id="testcaseBuilder-form" method="post">
						<div class="widget">
							<div class="navbar">
							...
							<div class="well">
								...
								<div class=" control-group">
									...
									<div class="span6">
										<div class="span5">
											<label class="control-label span12">Segment
												Description</label>
										</div>
										<div class="span7">
											<textarea id="segmentDescription" name="segmentDescription"
								...
								<div class=" control-group">
									<div class="span6">
										<div class="span5">
											<label class="control-label span12">Segment Run Start
												Date</label>
										</div>
										<div class="span7">
											<input class="span12" type="text" size="50"
												name="segmentCreationStartDate"
												id="segmentCreationStartDate"
												placeholder="Segment Creation Start Date" />
										</div>
									</div>
									<div class="span6">
										<div class="span5">
											<label class="control-label span12">Segment Run End
												Date</label>
										</div>
										<div class="span7">
											<input class="span12" type="text" size="50"
								...
								<div class=" control-group">
									<div class="span6">
										<div class="span5">
											<label class="control-label span12">Segment Process
												Time</label>
										</div>
										<div class="span7">
											<input class="span12" type="text" size="50"
								...
								<div class="navbar">
									<div class="navbar-inner">
										<div class="span2 center">
											<span id="programBuilderButton"
												class="btn btn-block btn-info"> Flow Builder </span>
										</div>
									</div>
								</div>
							</div>
